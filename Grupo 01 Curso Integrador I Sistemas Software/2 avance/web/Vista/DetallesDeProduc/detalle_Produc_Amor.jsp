        ...
        <div class="container content-wrapper"> <!-- Contenedor blanco -->
            <div class="product-page">
                ...
                <div class="product-info">
                    ...
                    <!-- Form to Add to Cart -->
                    <form action="${pageContext.request.contextPath}/Controlador/ControlCarrito" method="post">
                        <div class="product-options">
                            ...
                            <input type="hidden" name="id_flor" value="4"> <!-- ID de la flor -->
                    ...
                    <script>
                        function agregarAlCarrito() {
                            ...
                            const florId = 4; // ID de la flor
                            const url = `${pageContext.request.contextPath}/Controlador/ControlCarrito?action=agregar&id_flor=${florId}&cantidad=${cantidad}`;
