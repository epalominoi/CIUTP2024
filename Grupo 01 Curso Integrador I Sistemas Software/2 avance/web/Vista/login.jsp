...
<html lang="en">
    ...
    <body>
        ...
        <script>
    const contextPath = '${pageContext.request.contextPath}'; // Asigna el contexto a una variable JavaScript

    document.getElementById('btn-registro').addEventListener('click', function () {
        window.location.href = contextPath + '/Vista/register.jsp'; // Redirige a la página de registro
    });
</script>
